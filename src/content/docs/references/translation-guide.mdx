...
```json
  "_META": {
    ...
    "language": "Language Name"       // Replace with the full name of the language (e.g., "Türkçe") in the NATIVE LANGUAGE
  },
```
...
3. Go to `src/locales/en.json` and find the newly translated strings by either looking through the file or checking the latest commit's changes.

4. Once you have found the strings, copy them into your translation file (e.g `ee.json`) and translate them.
